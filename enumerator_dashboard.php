...
<html>
<head>
    <title>Population Census Management System - Enumerator Dashboard</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        <h1 class="dashboard-heading">Population Census Management System - Enumerator Dashboard</h1>
        ...
        <div class="row">
            ...
            <!-- <div class="col-md-6">
                <div class="dashboard-card">
                    ...
                    <a href="#" class="btn btn-primary">Manage Enumerators</a>
                </div>
            </div> -->
            ...
            <div class="col-md-6">
                <div class="dashboard-card">
                    ...
                    <a href="logout.php" class="btn btn-danger" style='background-color: brown;'>Logout</a>
                </div>
            </div>
